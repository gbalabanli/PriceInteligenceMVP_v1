...
## Phase 01
- `phase-01/scope-brief-and-prioritized-features.md`
- `phase-01/page-inventory-and-navigation-matrix.md`
- `phase-01/visual-baseline-note.md`
- `phase-01/localization-scope-note.md`
- `phase-01/dynamic-pricing-simulation-action-contract.md`
- `phase-01/mock-data-spec-draft.md`

## Phase 02
- `phase-02/visual-design-system-baseline.md`
- `phase-02/theme-token-sheet.md`
- `phase-02/localization-copy-sheet.md`
- `phase-02/clickable-prototype-and-navigation-map.md`
